...
import { TrendingUpIcon, SquareMousePointerIcon, GlobeIcon, VideoIcon, UsersIcon, ShieldCheckIcon, SettingsIcon, CalendarIcon, TerminalIcon, CodeIcon, ZapIcon } from "lucide-react";
...
function FeatureTitle({ className, children, upcoming, ...props }: React.ComponentProps<"h3"> & { upcoming?: boolean }) {
	return (
		<h3
			className={cn("font-medium text-foreground text-lg flex items-center justify-center gap-2", className)}
			{...props}
		>
            {children}
            {upcoming && (
		...
		<div className="grid h-full sm:grid-cols-2">
			<div className="relative z-10 space-y-6 py-8 ps-8 pe-2">
				<div className="flex size-12 items-center justify-center rounded-full border bg-card shadow-xs outline outline-border/80 outline-offset-2">
					<SettingsIcon className="size-5 text-primary/80" />
				</div>
				<div className="space-y-2 text-left">
					<FeatureTitle className="text-base justify-start">
						Host Controls
					</FeatureTitle>
					<FeatureDescription>
...
function TerminalVisual() {
    return (
        <>
            ...
            <div className="relative mt-8 space-y-1.5 text-center">
                <FeatureTitle upcoming>Integrated Terminal</FeatureTitle>
                <FeatureDescription>
...
function CodeSandboxVisual() {
    return (
        <>
            ...
            <div className="relative mt-8 space-y-1.5 text-center">
                <FeatureTitle upcoming>Live Code Sandbox</FeatureTitle>
                <FeatureDescription>
